...
package com.drwang.views.support.filter;
...
public class SupernovaFilter implements IImageFilter{
    ...
    public SupernovaFilter(int cr, int radius, int count){
    	 this(new RadialDistortionFilter.Point(0.0f, 0.0f), cr, radius, count);
    }
   
    public SupernovaFilter(RadialDistortionFilter.Point pt, int cr, int radius, int count)
    {
        _pt = pt ;
